...
export const SignupPage: React.FC = () => {
    ...
    return (
        <Layout>
            <div 
                ref={containerRef}
                className="min-h-[95vh] flex items-center justify-center relative overflow-hidden py-24 px-4 sm:px-6 lg:px-8 bg-dark-950"
            >
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-dark-950 via-dark-950/40 to-transparent z-0 pointer-events-none" />

                <div className="max-w-xl w-full space-y-10 bg-dark-900/40 backdrop-blur-2xl p-10 rounded-3xl shadow-[0_0_50px_-12px_rgba(0,0,0,0.5)] border border-white/10 z-10 relative animate-fade-in transition-all duration-500 hover:border-gold-500/20">
                    <div className="text-center">
                        <div className="flex justify-center mb-6">
                            <div className="bg-gold-500/10 p-5 rounded-2xl backdrop-blur-md border border-gold-500/20 shadow-inner">
                                <UserPlus className="text-gold-500" size={40} />
                            </div>
                        </div>
                        <h2 className="text-4xl font-serif font-bold text-white tracking-tight">
                            Join <span className="text-gold-500">FolkMint</span>
                        </h2>
                        <p className="mt-4 text-sm text-slate-400 font-medium">
                            Already part of our community?{' '}
                            <Link to="/login" className="text-white hover:text-gold-400 underline underline-offset-4 decoration-white/20 hover:decoration-gold-500 transition-all font-bold">
                                Sign in
                            </Link>
                        </p>
                    </div>
                    ...
                    <form className="space-y-8" onSubmit={handleSubmit}>
                        ...
                        <div className="space-y-6">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div className="group">
                                    <label htmlFor="firstName" className="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2 px-1 group-focus-within:text-gold-500 transition-colors">
                                        First Name
                                    </label>
                                    <input
                                        id="firstName"
                                        ...
                                        className="appearance-none block w-full px-5 py-4 bg-white/5 border border-white/10 placeholder-slate-600 text-white rounded-xl focus:outline-none focus:ring-1 focus:ring-gold-500/40 focus:border-gold-500/40 transition-all duration-300 text-sm"
                                        placeholder="John"
                                    />
                                </div>
                                <div className="group">
                                    <label htmlFor="lastName" className="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2 px-1 group-focus-within:text-gold-500 transition-colors">
                                        Last Name
                                    </label>
                                    <input
                                        id="lastName"
                            ...
                            <div className="group">
                                <label htmlFor="address" className="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2 px-1 group-focus-within:text-gold-500 transition-colors">
                                    Shipping Address
                                </label>
                                <input
                                    id="address"
